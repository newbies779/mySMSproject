...
<div class="containe-fluid" id="tableContent">
                ...
                <table class="table table-hover" style="width: 100%;" cellspacing="0" id="itemtable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="pos-left" id="itemidforrent<?= $i; ?>"> {{ $rent->item->item_id }} </td>
...
$(document).ready(function() {
    ...
    var stickyNav = function(){
        ...
        if (scrollTop > stickyHead) {
            ...
            var nav_height = $('#nav-header').height();
            //$('.grid-header.sticky').css('margin-top', 0);
        } else {
            $('.grid-header').removeClass('sticky');
            //$('.grid-header').css('margin-top', 1.5 * parseFloat($("body").css("font-size")));
        }
    };
